...
var blogs_detail_1 = __importDefault(__webpack_require__(55));
var App = function () {
            ...
            React.createElement("div", { className: "nav" },
                React.createElement("ul", null,
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: '/' }, "\u535A\u5BA2")),
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: '/test1' }, "\u5176\u4ED6")))),
...
var React = __importStar(__webpack_require__(1));
var react_router_dom_1 = __webpack_require__(10);
var cos_js_sdk_v5_1 = __importDefault(__webpack_require__(35));
var config_1 = __webpack_require__(52);
__webpack_require__(53);
var useState = React.useState, useEffect = React.useEffect;
var Blogs = function () {
    var cos = new cos_js_sdk_v5_1.default(config_1.cosKey);
    var _a = useState([]), list = _a[0], setList = _a[1];
    var getBucketListData = function () {
        cos.getBucket(config_1.BucketConf, (function (err, data) {
            var contents = data.Contents;
            setList(contents.map(function (item, index) { return ({ title: item.Key, id: index }); }));
        }));
    };
    useEffect(function () {
        getBucketListData();
    }, ['list']);
    return (React.createElement("div", { className: "app-blogs" },
        React.createElement("ul", { className: "app-blogs-ul-wrapper" }, list.map(function (item, index) {
            return (React.createElement("li", { key: index },
                React.createElement(react_router_dom_1.Link, { to: "/blogs/" + item.id }, item.title)));
        }))));
};
...
var COS = __webpack_require__(36);
module.exports = COS;
...
var advance = __webpack_require__(50);
...
var xml2json = __webpack_require__(40);
 ...
 */
var DOMParser = __webpack_require__(41).DOMParser;
...
//if(typeof require == 'function'){
	var XMLReader = __webpack_require__(42).XMLReader;
...
var EventProxy = __webpack_require__(45).EventProxy;
var util = __webpack_require__(37);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cosKey", function() { return cosKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BucketConf", function() { return BucketConf; });

const cosKey = {
    SecretId: 'AKIDoWAg1Dh4lgYL0Wt00oUzKUTH9gBYnmcL',
    SecretKey: 'nfcT9mkdEhz64KXny9Az6NZaQ5hOvKcm'
};

const BucketConf = {
    Bucket: 'myblog-1252092265',
    Region: 'ap-chengdu'
}
